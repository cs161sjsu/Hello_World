...
class FollowersViewController: UIViewController, IndicatorInfoProvider, ChartViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        if(userAccount.socialMediaName == "Youtube"){
            followersNumberLabel.text = "Subscribers: \(userAccount.followers)"
        }
        else{
            followersNumberLabel.text = "Followers: \(userAccount.followers)"
        }
    }
    ...
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        if(userAccount.socialMediaName == "Youtube"){
            return IndicatorInfo(title:"Subscribers")
        }
        else{
