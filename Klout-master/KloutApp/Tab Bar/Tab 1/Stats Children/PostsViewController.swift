...
class PostsViewController: UIViewController, IndicatorInfoProvider, ChartViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        if(userAccount.socialMediaName == "Youtube"){
            postsNumberLabel.text = "Videos: \(userAccount.posts)"
        }
        else if(userAccount.socialMediaName == "Twitter"){
            postsNumberLabel.text = "Tweets: \(userAccount.posts)"
        }
        else{
            postsNumberLabel.text = "Posts: \(userAccount.posts)"
        }
